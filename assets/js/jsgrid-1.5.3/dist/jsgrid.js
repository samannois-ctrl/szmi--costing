...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _setOptionDirect: function(name,value){
            this[name] = value;
        ...
        _createCell: function(item, field) {
            ...
            if($.isFunction(field.cellRenderer)) {
                ...
                $result = this.renderTemplate(field.cellRenderer, field, args);
                 ...
                 // console.log('ft',field.itemTemplate)
                 // console.log('f',field)
        ...
        editItem: function(item) {
            ...
            //console.log('row-no-edit=',$row.hasClass('row-no-edit'));
            if( $row.length &&  ! $row.hasClass('row-no-edit') ) {
                this._editRow($row);
            }
        },
...
(function(jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        editValue: function() {
            ...
            var d = this.valueType === numberValueType ? parseInt(val || 0, 10) : val;
