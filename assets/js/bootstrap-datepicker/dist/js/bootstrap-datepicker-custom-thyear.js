    ...
    */
    ...
    var DPGlobal = {
        ...
        parseDate: function (date, format, language, assumeNearby) {
            ...
            if(isThaiYear==true && typeof parts[2] !== 'undefined'){

                
                if(parts[2].length == 2){

                    var th_year = 2500 + parseInt(parts[2]);
                    parts[2] = th_year - yearOffSet;

                }else{

                    parts[2] = parts[2] - yearOffSet;
        ...
        formatDate: function (date, format, language) {
            ...
            var val = {
                ...
                yy: (date.getUTCFullYear() + yearOffSet).toString().substring(2),
                /* 9:50 20/10/2559
                www.javascriptthai.com
